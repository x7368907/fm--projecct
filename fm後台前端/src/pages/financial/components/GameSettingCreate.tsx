...
// 定義 Props 介面
interface GameSettingCreateProps {
  onCancel: () => void
  onSave: (values: any) => void
  initialValues?: any // ★ 新增：接收編輯資料
}

export default function GameSettingCreate({
  onCancel,
  onSave,
  initialValues,
}: GameSettingCreateProps) {
        ...
        >
          ...
          >
            ...
            <Select
              placeholder="請選擇"
              options={[
                { label: '電子', value: '電子' }, // value 需對應資料內容
                { label: '真人', value: '真人' },
              ]}
              disabled={isEdit}
            />
          ...
          <Form.Item
            label="遊戲商選擇"
            name="vendorName" // 注意欄位名稱需與資料對應 (vendorName vs vendor)
          ...
          <Form.Item
            label="遊戲上繳結算日"
            name="settlementType" // 這裡簡單對應 settlementType，實際可能要拆分日期
